...
samples_4l = [ 'ZZ', 'ZZewk', 'ttV', 'Red' ]
samples_2l2v = [ 'ZZ', 'ZZewk', 'ttV', 'Zjets', 'WZ', 'emu', 'Top', 'Wjets' ]

original_colors_4l = { 'ZZ' : [ 926 ], 'ZZewk': [ 932 ], 'ttV': [ 928 ], 'Red': [ 927 ] }
original_colors_2l2v = { 'ZZ' : [ 65 ], 'WZ': [ 98 ], 'emu': [ 17 ], 'Zjets': [ 5 ], 'ZZewk': [ 8 ], 'Wjets': [ 9 ], 'ttV': [ 41 ], 'Top': [ 7, 1 ] }

titles = { 'ZZ': zz, 'ZZewk': zz + ' (EW)', 'ZZfull': zz, 'ttV': '#it{t#bar{t}+V}, #it{VVV}', 'Red': '#it{Z}+jets, #it{t#bar{t}}', 'WZ': '#it{WZ}', 'emu': '#it{WW}, #it{Wt}, #it{t#bar{t}}, #it{Z}#rightarrow#tau#tau', 'Zjets': '#it{Z}+jets', 'Top': 'single top', 'Wjets': '#it{W}+jets', 'other': 'Other backgrounds' } #'single top, #it{t#bar{t}+V}, #it{VVV}' }
...
def get_colors( name ):
  colors = { 
    'ZZ': ROOT.TColor.GetColor( '#CB0B09' ), #ROOT.kRed + 1,
    'ZZewk': ROOT.TColor.GetColor( '#003366' ), #ffffff' ), #'#B5236F' ), 
    'ZZfull': ROOT.TColor.GetColor( '#e20d0a' ), #ROOT.kRed + 1,
    'ttV': ROOT.TColor.GetColor( '#f2ee57' ), #'#EDE810' ), 
    'Red': ROOT.TColor.GetColor( '#5a1137' ), #'#793FD2' ), 
    'WZ': ROOT.TColor.GetColor( '#64c7f6' ), 
    'emu': ROOT.TColor.GetColor( '#f89326' ), #'#faac58' ), #'#5bd863' ), 
    'Zjets': ROOT.kYellow - 9, 
    'Top': ROOT.TColor.GetColor( '#585858' ), #ROOT.kGray + 1, 
    'other': ROOT.TColor.GetColor( '#417508' ), #'#585858' ),
    'Wjets': ROOT.TColor.GetColor( '#e8bdd3' )
  }
  return colors[ name ]
...
def create_legend( num, width = 0.4, cols = 2 ):
  ...
  leg = ROOT.TLegend( xLeg, yLeg - 0.055 * ( num + 2 ), xLeg + width, yLeg )
  leg.SetFillStyle( 0 )
  leg.SetBorderSize( 0 )
  leg.SetTextFont( 43 )
  leg.SetTextSize( 16 )
