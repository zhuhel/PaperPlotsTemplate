...
def main():
  ...
  make_plot( 'm4l_VBF_4l.root',   'VBF-enriched', utils.h_to_zz_to + utils.four_l + utils.inv_prime,     400, ) #0.02, 2.98 )
  make_plot( 'm4l_ggF_4l.root',   'ggF-enriched', utils.h_to_zz_to + utils.four_l + utils.inv_prime,     100000, 0.0, 3.2 )
  #make_plot( 'm4l_ggF_2l2l.root', 'ggF-enriched', utils.h_to_zz_to + utils.lepp + utils.lepm + utils.lepp + '\\prime' + utils.lepm + '\\prime', 10000 )
  make_plot( 'm4l_ggF_2l2l.root', 'ggF-enriched', utils.h_to_zz_to + utils.lepp + utils.lepm + utils.lepp + '\'' + utils.lepm + '\'', 10000 )
  make_plot( 'm4l_ggF_4e.root',   'ggF-enriched', utils.h_to_zz_to + utils.ep + utils.em + utils.ep + utils.em + utils.inv_prime,     5000 )
  make_plot( 'm4l_ggF_4mu.root',  'ggF-enriched', utils.h_to_zz_to + utils.mup + utils.mum + utils.mup + utils.mum + utils.inv_prime,   5000 )
